...
This technical specification defines rebuild-critical implementation constraints for @acx/agent-runtime Execution Library. The intent is to allow a new team to recreate equivalent runtime behavior from documents alone.
