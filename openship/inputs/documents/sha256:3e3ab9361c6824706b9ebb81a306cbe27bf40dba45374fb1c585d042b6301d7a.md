...
This technical specification defines rebuild-critical implementation constraints for AntiClodeX Active Runtime. The intent is to allow a new team to recreate equivalent runtime behavior from documents alone.
