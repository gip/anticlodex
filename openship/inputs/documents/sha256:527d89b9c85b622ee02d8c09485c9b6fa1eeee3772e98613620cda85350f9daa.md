...
- Dependency flow to @acx/agent-runtime Execution Library using transport unspecified protocol and application semantics unspecified application protocol.
